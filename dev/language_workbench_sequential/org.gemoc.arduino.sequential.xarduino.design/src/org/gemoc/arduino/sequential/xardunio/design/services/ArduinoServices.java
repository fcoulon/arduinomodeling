...
//	}
	...
	public String getModuleAssignmentIcon(ModuleAssignment moduleAssignment) {
		if (moduleAssignment.getModule() instanceof ArduinoAnalogModule) {
			return "/org.gemoc.arduino.sequential.xarduino.design/icons/Level.png";
		} else if (moduleAssignment.getModule() instanceof ArduinoDigitalModule) {
			return "/org.gemoc.arduino.sequential.xarduino.design/icons/Status.png";
		}
...
//	}
	...
	public String getImage(Module module) {
		if (module instanceof LED) {
			...
			return "/org.gemoc.arduino.sequential.xarduino.design/images/dfrobot/buzzer.jpg";
		}
		else if (module instanceof PushButton) {
			return "/org.gemoc.arduino.sequential.xarduino.design/images/dfrobot/push_button.jpg";
		}
		else if (module instanceof MicroServo) {
			return "/org.gemoc.arduino.sequential.xarduino.design/images/dfrobot/servo.jpg";
		}
		else if (module instanceof InfraRedSensor) {
			return "/org.gemoc.arduino.sequential.xarduino.design/images/dfrobot/infrared.jpg";
		}
		else if (module instanceof Fan) {
			return "/org.gemoc.arduino.sequential.xarduino.design/images/fan.jpg";
		}
		else if (module instanceof MusicPlayer) {
			return "/org.gemoc.arduino.sequential.xarduino.design/images/music_player.jpg";
		}
		else if (module instanceof AmbientLightSensor) {
			return "/org.gemoc.arduino.sequential.xarduino.design/images/dfrobot/ambient_light.jpg";
		}
		else if (module instanceof RotationSensor) {
			return "/org.gemoc.arduino.sequential.xarduino.design/images/dfrobot/rotation_sensor_v1.jpg";
		}
		else if (module instanceof SoundSensor) {
			return "/org.gemoc.arduino.sequential.xarduino.design/images/dfrobot/sound_sensor.jpg";
		}
