 ...
 * </p>
 * <ul>
 *   <li>{@link arduinoTrace.States.arduino.impl.TracedDelayImpl#getOriginalObject <em>Original Object</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TracedDelayImpl extends TracedUtilitiesImpl implements TracedDelay {
	/**
	...
	protected EClass eStaticClass() {
		return ArduinoPackage.Literals.TRACED_DELAY;
	}
		...
		if (originalObject != null && originalObject.eIsProxy()) {
			...
			if (originalObject != oldOriginalObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ArduinoPackage.TRACED_DELAY__ORIGINAL_OBJECT, oldOriginalObject, originalObject));
			}
		}
	...
	public void setOriginalObject(Delay newOriginalObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoPackage.TRACED_DELAY__ORIGINAL_OBJECT, oldOriginalObject, originalObject));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ArduinoPackage.TRACED_DELAY__ORIGINAL_OBJECT:
