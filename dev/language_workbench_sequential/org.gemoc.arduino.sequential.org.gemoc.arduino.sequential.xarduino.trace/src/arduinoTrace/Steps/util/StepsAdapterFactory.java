...
public class StepsAdapterFactory extends AdapterFactoryImpl {
	...
	protected StepsSwitch<Adapter> modelSwitch =
		new StepsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseArduino_Instruction_Execute(Arduino_Instruction_Execute object) {
				return createArduino_Instruction_ExecuteAdapter();
			}
			@Override
			public Adapter caseArduino_Instruction_Execute_AbstractSubStep(Arduino_Instruction_Execute_AbstractSubStep object) {
				return createArduino_Instruction_Execute_AbstractSubStepAdapter();
			}
			@Override
			public Adapter caseArduino_Instruction_Execute_ImplicitStep(Arduino_Instruction_Execute_ImplicitStep object) {
				return createArduino_Instruction_Execute_ImplicitStepAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseArduino_ModuleInstruction_Execute(Arduino_ModuleInstruction_Execute object) {
				return createArduino_ModuleInstruction_ExecuteAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link arduinoTrace.Steps.Arduino_Instruction_Execute <em>Arduino Instruction Execute</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createArduino_Instruction_ExecuteAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link arduinoTrace.Steps.Arduino_Instruction_Execute_AbstractSubStep <em>Arduino Instruction Execute Abstract Sub Step</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createArduino_Instruction_Execute_AbstractSubStepAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link arduinoTrace.Steps.Arduino_Instruction_Execute_ImplicitStep <em>Arduino Instruction Execute Implicit Step</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createArduino_Instruction_Execute_ImplicitStepAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link arduinoTrace.Steps.Arduino_ModuleInstruction_Execute <em>Arduino Module Instruction Execute</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createArduino_ModuleInstruction_ExecuteAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link arduinoTrace.Steps.SpecificRootStep <em>Specific Root Step</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
