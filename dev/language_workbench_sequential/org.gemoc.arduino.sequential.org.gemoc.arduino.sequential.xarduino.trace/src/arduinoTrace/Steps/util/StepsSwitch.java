...
public class StepsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StepsPackage.ARDUINO_INSTRUCTION_EXECUTE: {
				Arduino_Instruction_Execute arduino_Instruction_Execute = (Arduino_Instruction_Execute)theEObject;
				T result = caseArduino_Instruction_Execute(arduino_Instruction_Execute);
				if (result == null) result = caseArduino_If_Execute_AbstractSubStep(arduino_Instruction_Execute);
				if (result == null) result = caseArduino_Repeat_Execute_AbstractSubStep(arduino_Instruction_Execute);
				if (result == null) result = caseSequentialStep(arduino_Instruction_Execute);
				if (result == null) result = caseArduino_Instruction_Execute_AbstractSubStep(arduino_Instruction_Execute);
				if (result == null) result = caseSpecificStep(arduino_Instruction_Execute);
				if (result == null) result = caseBigStep(arduino_Instruction_Execute);
				if (result == null) result = caseStep(arduino_Instruction_Execute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StepsPackage.ARDUINO_INSTRUCTION_EXECUTE_ABSTRACT_SUB_STEP: {
				Arduino_Instruction_Execute_AbstractSubStep arduino_Instruction_Execute_AbstractSubStep = (Arduino_Instruction_Execute_AbstractSubStep)theEObject;
				T result = caseArduino_Instruction_Execute_AbstractSubStep(arduino_Instruction_Execute_AbstractSubStep);
				if (result == null) result = caseSpecificStep(arduino_Instruction_Execute_AbstractSubStep);
				if (result == null) result = caseStep(arduino_Instruction_Execute_AbstractSubStep);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StepsPackage.ARDUINO_INSTRUCTION_EXECUTE_IMPLICIT_STEP: {
				Arduino_Instruction_Execute_ImplicitStep arduino_Instruction_Execute_ImplicitStep = (Arduino_Instruction_Execute_ImplicitStep)theEObject;
				T result = caseArduino_Instruction_Execute_ImplicitStep(arduino_Instruction_Execute_ImplicitStep);
				if (result == null) result = caseArduino_Instruction_Execute_AbstractSubStep(arduino_Instruction_Execute_ImplicitStep);
				if (result == null) result = caseSmallStep(arduino_Instruction_Execute_ImplicitStep);
				if (result == null) result = caseSpecificStep(arduino_Instruction_Execute_ImplicitStep);
				if (result == null) result = caseStep(arduino_Instruction_Execute_ImplicitStep);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StepsPackage.ARDUINO_MODULE_ASSIGNMENT_EXECUTE: {
				...
				if (result == null) result = caseSmallStep(arduino_ModuleAssignment_Execute);
				if (result == null) result = caseStep(arduino_ModuleAssignment_Execute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StepsPackage.ARDUINO_MODULE_INSTRUCTION_EXECUTE: {
				Arduino_ModuleInstruction_Execute arduino_ModuleInstruction_Execute = (Arduino_ModuleInstruction_Execute)theEObject;
				T result = caseArduino_ModuleInstruction_Execute(arduino_ModuleInstruction_Execute);
				if (result == null) result = caseSpecificStep(arduino_ModuleInstruction_Execute);
				if (result == null) result = caseSmallStep(arduino_ModuleInstruction_Execute);
				if (result == null) result = caseStep(arduino_ModuleInstruction_Execute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case StepsPackage.ARDUINO_UTILITIES_EXECUTE: {
				...
				if (result == null) result = caseSpecificStep(arduino_Utilities_Execute);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Arduino Instruction Execute</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Arduino Instruction Execute</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseArduino_Instruction_Execute(Arduino_Instruction_Execute object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Arduino Instruction Execute Abstract Sub Step</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Arduino Instruction Execute Abstract Sub Step</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseArduino_Instruction_Execute_AbstractSubStep(Arduino_Instruction_Execute_AbstractSubStep object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Arduino Instruction Execute Implicit Step</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Arduino Instruction Execute Implicit Step</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseArduino_Instruction_Execute_ImplicitStep(Arduino_Instruction_Execute_ImplicitStep object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Arduino Module Instruction Execute</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Arduino Module Instruction Execute</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseArduino_ModuleInstruction_Execute(Arduino_ModuleInstruction_Execute object) {
		return null;
	}
