 ...
 * @generated
 */
public class Arduino_If_ExecuteImpl extends SpecificStepImpl implements Arduino_If_Execute {
	/**
	 ...
	 * @generated
	 */
	public TracedIf getCaller() {
		return (arduinoTrace.States.arduino.TracedIf) this.getMseoccurrence().getMse().getCaller();
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == BigStep.class) {
			switch (derivedFeatureID) {
				case StepsPackage.ARDUINO_IF_EXECUTE__SUB_STEPS: return TracePackage.BIG_STEP__SUB_STEPS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == BigStep.class) {
			switch (baseFeatureID) {
				case TracePackage.BIG_STEP__SUB_STEPS: return StepsPackage.ARDUINO_IF_EXECUTE__SUB_STEPS;
				default: return -1;
			}
		}
		if (baseClass == SequentialStep.class) {
